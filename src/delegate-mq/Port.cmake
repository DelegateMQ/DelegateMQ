...
file(GLOB FAULT_SOURCES CONFIGURE_DEPENDS
...
if (DMQ_DATABUS STREQUAL "ON")
    ...
    file(GLOB DATABUS_SOURCES CONFIGURE_DEPENDS "${DMQ_ROOT_DIR}/extras/databus/*.h")
...
file(GLOB DMQ_LIB_SOURCES CONFIGURE_DEPENDS
    "${DMQ_ROOT_DIR}/*.h"
