...
/// dmq::util::TimerDelegate dispatching to the real FreeRTOS (POSIX/Linux
...
// drive Timer::ProcessTimers() -- main_delegate.cpp's periodic system timer
// (SysTimer, started before ExecuteAllTests() runs and still active here)
// already does that every 10ms, the same one Test 8 relies on.
