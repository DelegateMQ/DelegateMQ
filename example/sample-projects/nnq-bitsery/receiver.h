...
/// 
/// @brief NNG with remote delegates examples. 
...
using namespace dmq::serialization::bitsery;
using namespace std;
...
public:
        ...
        m_argStream(ios::in | ios::out | ios::binary)
    {
        ...
        // Set the transport
        m_transport.Create(NngTransport::Type::SUB, "tcp://localhost:5555");
